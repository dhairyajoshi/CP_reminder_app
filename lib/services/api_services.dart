...
class Api {
  Future<List<Contest>> getContests() async {
    ...
    final response = await http.get(
        Uri.parse(
            'https://clist.by:443/api/v3/contest/?username=coderr_&api_key=50782e56c2c92c88f7cd83e95e54924ae7971376&start__gt=${formatted}T00:00:00&order_by=end&limit=30&format_time=true'),
